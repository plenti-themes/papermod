...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			p = element("p");
			t2 = text("Welcome to demo of Plenti's theme PaperMod.");
			t3 = space();
			ul = element("ul");
			li0 = element("li");
		...
		l(nodes) {
			...
			t2 = claim_text(p_nodes, "Welcome to demo of Plenti's theme PaperMod.");
